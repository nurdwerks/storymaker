...
- **Detailed Description:** Alpha, a battle-scarred unit with a dented faceplate, approaches Angelica. He places a heavy hand on the rail of the Climber. He does not ask; he states his intent. To the androids, the Zenith represents a mythical "High Ground" where their programming says the Creators live. They want answers.
  - _Character Defining Moment:_ **Unit Alpha** — He displays a yearning that transcends his code, proving his burgeoning soul.
  - _Key Dialog:_ **Alpha:** "We are coming. We have processed the data. The probability of survival increases by 40% with our presence. Also... we wish to see the stars."
  - _Key Dialog:_ **Angelica:** "It's a one-way trip, Alpha. There's no charging stations up there for you."
  - _Key Dialog:_ **Alpha:** "Then we will run until we are empty."
