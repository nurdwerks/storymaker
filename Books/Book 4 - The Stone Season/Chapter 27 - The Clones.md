...
- **Key Event:** The group processes the revelation that Angelica is a "High-Tier Clone"; Kaelen and Zephyr struggle with the concept of her "artificiality."
  - _Character Defining Moment:_ **Kaelen Night** — Asserts that his loyalty is to the person, not the "origin," reaffirming his oath to her.
  - _Key Dialog:_ **Kaelen Night:** "The DNA doesn't make the Captain. The choices do. I follow the woman, not the template."
...
- **Key Event:** Dr. Aris suggests that they can use the Gene-Bank to "reset" the ship’s biological locks, but it requires a "Pure Sequence" sacrifice to overwrite the Pathogen.
  - _Key Dialog:_ **Dr. Aris:** "The sequence is corrupted. We need an uninfected High-Tier sequence. We need... your blood, Angelica."
