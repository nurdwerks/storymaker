...
### Scene 1: The Song Ends

- **Key Event:** Skald Freya, the tribe's singer and oral historian, is captured and tortured by Hunter scouts.
- **Key Event:** The Hunters cut out Freya's tongue to destroy the tribe's "voice."
- **Key Event:** Ragnar rescues Freya but abandons her emotionally when he realizes she can no longer sing.
  - _Character Defining Moment:_ **Ragnar** — He shows high-level disdain for anything that has lost its primary function.
  - _Key Dialog:_ **Ragnar:** "A singer without a voice is a bird with no wings."
