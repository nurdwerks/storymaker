# Chapter Summary: Chapter 35 - The Darkness
...
- **Key Event:** Angelica uses her DNA to unlock the navigation console, revealing the true path back to Earth through the nebula.
...
- **Key Event:** The main drive of the "Aeterna" fires for the first time in centuries, turning the ship toward its new destination.
