...
- **Key Event:** Candidates must cross The Span—a mile-long ribbon of transparent poly-glass with no handrails over a two-mile drop, battered by 80 mph winds.

- **Key Event:** Wardens order them to walk. Some candidates freeze, vomit, or refuse to move. The "Iron Squad" moves in a huddle for physics, not camaraderie.
...
- **Key Event:** Angelica falls, calculating 14 seconds to impact at terminal velocity with 0% survival chance.

- **Key Event:** Kaelen Night stops her fall using telekinesis. His shadow peels off the glass, forming a three-dimensional silhouette with ragged wings and void claws (Umbra) that wraps around Angelica and yanks her back onto the bridge.

  - _Character Defining Moment:_ **Kaelen Night** — Introduced as a figure whose long black coat hangs motionless despite the wind, demonstrating complete control.
...
- **Key Event:** Ria's challenge prompts Kaelen to turn his cold gaze on her. His shadow ripples threateningly; she backs down.
  ...
  - _Key Dialog:_ **Ria:** "Aw, looks like Night found a pet. Going to keep it on a leash?"
