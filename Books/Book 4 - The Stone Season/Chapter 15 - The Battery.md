...
- **Key Event:** The group finds a single, fully-charged "Zenith Core" battery in an abandoned cargo lift, but they must choose between using it for heat or for a one-time radio transmission.
  - _Key Dialog:_ **Dr. Aris:** "The signal reach the Spire remnants. We could call for an extraction. We could be saved."
  - _Key Dialog:_ **Ria:** "Or we could freeze to death tonight. Extraction doesn't help frozen meat."
