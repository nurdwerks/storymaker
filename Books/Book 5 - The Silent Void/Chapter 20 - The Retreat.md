...
- **Key Event:** The survivors find themselves in a service corridor with a localized hull breach, forced to use emergency sealants while the ship's AI reports the arrival of the main alien fleet.
  ...
  - _Character Defining Moment:_ **Lisbet** — Repairs the environmental terminal in record time to restore local oxygen, showing her technical prowess under extreme pressure.
  - _Key Dialog:_ **AI:** "Multiple contacts detected. Fleet deployment confirmed. Prey status: Found."
