...
- **Key Event:** Angelica's physical body goes limp and her eyes turn entirely gold, marking the completion of her transition from human pilot to living ship computer.

  - _Character Defining Moment:_ **Prelate Vane** — Watches the procedure with clinical detachment, warning Kaelen that any interference would "lobotomize" her.
  - _Key Dialog:_ **Prelate Vane:** "Let the signal lock. Let her adjust."
