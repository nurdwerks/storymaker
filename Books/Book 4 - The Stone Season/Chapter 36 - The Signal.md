...
- **Key Event:** A response comes through, but it is not human; it is an automated "Containment Drone" signal from a nearby orbital platform.
  - _Character Defining Moment:_ **Dr. Aris** — Identifies the signal as a "Vane-Protocol" remnant, meaning Vane's ancestors may have been the ones who quarantined the ship in the first place.
  - _Key Dialog:_ **Dr. Aris:** "The signal is an echo of the quarantine. We weren't lost; we were locked away. Vane didn't start the infection; he just inherited the cage."

---

### Scene 3: The Threat

- **Key Event:** The drone platform begins a "Sterilization Sequence," targeting the Observation Deck with a high-energy pulse.
