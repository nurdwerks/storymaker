...
- **Key Event:** Angelica unveils her creation: The "Nemesis" Suit.
- **Detailed Description:** Angelica pulls the tarp away. Standing in the center of the workshop is a seven-foot-tall exoskeleton. It is crude, unpainted, the metal scarred and mismatched. But it is terrifying. The right arm ends in a massive rotary saw taken from a rock-cutter. The left arm mounts a heavy plasma cannon stripped from a turret. The cockpit is an armored cage designed to protect the pilot from anything short of a tank round. It is not a suit of armor; it is a walking tank.
- **Key Event:** Angelica climbs into the suit.
- **Detailed Description:** She steps into the frame. The hydraulics hiss as the suit accepts her weight. She locks the cage. The machine hums to life, the power core glowing an angry red. She takes a step, the floor shaking under the tonnage. She raises the saw arm and revs it. The sound is a scream of metal that drowns out all thought.
  - _Key Dialog:_ **Angelica Ward:** (Amplified by external speakers) "I am not hiding anymore. I am coming for him."

### Scene 5: The Iron Decree

- **Key Event:** In the Zenith Command Spire, General Ironwood receives orders from Vane to execute "Protocol Omega."
- **Detailed Description:** Ironwood stands in the pristine white command center. Vane is on the screen, looking impatient. He orders the release of Helium-3 into the ventilation system of Sector 4 to "pacify" the rioters. It is a death sentence for thousands. Ironwood looks at the order. He looks at his men. He is a soldier, not a butcher.
- **Internal Conflict:** Ironwood struggles with his loyalty to the chain of command versus his morality. He knows Vane is mad. He knows this is a war crime.
- **Key Event:** Major Steel, Ironwood's second-in-command, quietly opens a channel to Sector 4 and broadcasts a warning code.
- **Detailed Description:** Steel taps a sequence into his console while pretending to run diagnostics. A silent alarm trips in the Undercity. It gives them ten minutes to seal their masks. It is a small act of rebellion, but it saves lives.
- **Key Event:** The War Room is breached by Vane's loyalists who detected the leak.
- **Detailed Description:** The doors blow open. Vane's personal guard storms in. A firefight erupts in the command center. Sergeant "Brick" Wall, a massive loyalist to Ironwood, throws himself in front of the General, taking a volley of plasma fire meant for his commander.
  - _Character Defining Moment:_ **Sergeant "Brick" Wall** — He dies protecting his officer, proving that loyalty in the Guard is to the man, not the uniform.
  - _Key Dialog:_ **General Ironwood:** "Leave me the machines. Get the men out. We are leaving the Spire."
