...
- **Detailed Description:** Splicer is a thin, nervous man with cybernetic implants in his skull. He stands behind a wall of reinforced glass, typing frantically. He shouts orders to his assistant, Igor, a hulking, lobotomized brute.
  ...
  - _Key Dialog:_ **Dr. Splicer:** "You're too late! The data is already uploaded! You'll find nothing but ghosts here!"

### Scene 2: The Casualties

- **Key Event:** The firefight breaches the inner lab.
- **Detailed Description:** The glass wall shatters under concentrated fire. Igor charges, swinging a heavy wrench. Kaelen steps forward, his movement a blur. He sidesteps the blow and severs Igor's hamstrings with a precise cut of his mono-blade. Igor falls, screaming. Splicer draws a pistol, but he is a scientist, not a soldier.
- **Key Event:** Ria kills Dr. Splicer.
- **Detailed Description:** Ria doesn't hesitate. She puts a single round through Splicer's chest. He is thrown backward into his console, sparks flying as his body shorts out the equipment.
- **Key Event:** Lab Assistant Igor attempts to crawl away.
- **Detailed Description:** Igor drags himself across the floor, leaving a trail of blood. He pleads for mercy, claiming he was just following orders, just an assistant. Ria stands over him. She looks at the tanks lining the walls—tanks filled with failed experiments, twisted bodies floating in green fluid.
  - _Character Defining Moment:_ **Ria** — She shows no mercy. She judges him not by his rank, but by his complicity. She puts a boot on his chest.
  - _Key Dialog:_ **Igor:** "Wait—I'm just an assistant! I didn't—I just cleaned the tanks!"
  - _Key Dialog:_ **Ria:** "You watched. You cleaned up the blood. You should've picked a better boss." (She fires).

### Scene 3: The Archivist

- **Key Event:** The team locates the Data Core. Connected to it is "The Archivist."
- **Detailed Description:** In the center of the room, suspended in a web of cables, is an elderly man. His limbs have been amputated and replaced with data-ports. His eyes are gone, replaced by optical feeds directly into the server. He is a living hard drive, forced to process Vane's atrocities. He twitches as the data streams through his brain.
- **Key Event:** The Archivist begs for death.
- **Detailed Description:** Angelica approaches him. She realizes he is the source of the encryption. He can't disconnect. His mind is fragmented, shattered by the volume of data. He senses her presence.
  - _Character Defining Moment:_ **The Archivist** — He represents the ultimate victim of Vane's system—a human turned into a component. He bargains the only thing he has left—information—for the release of death.
  - _Key Dialog:_ **The Archivist:** "I remember everything. Every experiment. Every scream. It loops. It never stops. Please. Let me forget. Kill the feed."
  - _Key Dialog:_ **Angelica Ward:** "I can't save you. The interface is fused to your brain stem."
  - _Key Dialog:_ **The Archivist:** "Then end me. Give me the silence."
  - _Key Dialog:_ **Angelica Ward:** "Give us what we need. Unlock the files. Then you can rest."

### Scene 4: The Stand

- **Key Event:** Vane's elite reinforcements, the "Null-Squad," arrive at the laboratory exit.
- **Detailed Description:** The corridor outside fills with smoke. The Null-Squad are heavy shock troops, immune to pain, wearing armor that dampens energy weapons. There are twenty of them. The team is trapped in the lab. They need time to download the data from the dying Archivist.
...
- **Internal Conflict:** Angelica wants to stay. She wants to fight beside him. But she knows the mission is the data. The data brings down Vane. Kaelen is buying her that victory.
  ...
  - _Key Dialog:_ **Kaelen:** "Then it's a fair fight. Go! Don't let this be for nothing."
