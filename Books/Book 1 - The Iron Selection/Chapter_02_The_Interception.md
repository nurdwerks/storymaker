...
- **Key Event:** The air pressure changes and ventilation fans cut out. A polite tapping sound alerts Angelica to an intruder.

- **Key Event:** Prelate Vane appears on the railing—a tall, gaunt figure in pristine white robes with Multi-Spectral Oculars grafted into his skull.

  - _Character Defining Moment:_ **Prelate Vane** — Demonstrates terrifying competence by bypassing all of Angelica's security measures and identifying the flaw in her hack.
  - _Key Dialog:_ **Prelate Vane:** "You missed a semi-colon on line 400."
  - _Key Dialog:_ **Prelate Vane:** "The B-Flat bypass was clever... but you forgot that the Medical Grid creates a thermal echo when it reroutes power."

---

### Scene 3: The Spider in the Web
...
- **Key Event:** Vane examines and then crushes Angelica's Haptic Glove while still on her hand, declaring her work "brilliant" but wasted on petty theft.
  ...
  - _Key Dialog:_ **Prelate Vane:** "It is crude, ugly, unauthorized, and utterly brilliant."

---

### Scene 4: The Offer

- **Key Event:** Vane produces a vial containing the medicine Leo needs and dangles it over an incinerator chute.

- **Key Event:** Vane offers Angelica a deal: enter the Iron Selection at the Academy, where Squad Iron has an 88% mortality rate. If she wins, he will cure Leo permanently by rewriting his DNA.

  - _Character Defining Moment:_ **Prelate Vane** — Reveals his interest in Angelica as a "Null" who might be "coded" like a formatted hard drive rather than born with natural magic.
  - _Key Dialog:_ **Prelate Vane:** "I want to see if that mind of yours—that chaotic, brilliant, scavenging mind—can survive a real challenge."
