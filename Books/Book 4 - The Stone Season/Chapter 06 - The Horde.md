...
- **Key Event:** The group reaches the "Sector 12 Ventilation Hub," only to find the thermal dampeners have failed, causing a massive heat spike that alerts the local Blighted.
  ...
  - _Key Dialog:_ **Dr. Aris:** "Listen to the frequency. It's not a scream; it's a handshake. They're triangulating our position based on the heater's output."

---

### Scene 2: The Wave

- **Key Event:** A massive wave of Blighted (the "Horde") surges from the ventilation shafts, moving with unexpected coordination.
