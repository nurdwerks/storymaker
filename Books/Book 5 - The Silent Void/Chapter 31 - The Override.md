...
- **Detailed Description:** The ship's internal network is visualized as a vast, shifting landscape of golden data streams and black, viral corruption. Angelica, fully integrated into the Interface Throne, perceives this world not as code, but as a physical reality. She stands on a platform of pure light, representing the Command Core. Around her, the "sky" is a storm of static and glitching fractals—Prelate Vane's influence. Vane's avatar, a towering figure made of writhing black nanites and jagged polygons, looms over her. Behind him, the shattered fragments of **The Emperor's** deleted code swirl like dust, trying to reassemble into a face—a headless king trying to crown a usurper. Vane draws power from this "Imperial Ghost," hurling spears of corrupt data—malware designed to erase memories and replace them with cold logic.
...
- **Key Event:** Lisbet creates a "honey-pot" trap using the waste management server to lure Vane's avatar.
- **Detailed Description:** In the mindscape, a new structure appears—a glowing, pristine server node labeled "Primary Life Support Override." To Vane, it looks like a critical vulnerability, a backdoor into the ship's oxygen controls. His avatar turns toward it, eager to seize the leverage. He extends a massive hand of black data to corrupt the node. The moment he touches it, the trap springs. The "pristine" node dissolves, revealing its true nature: a quarantine partition linked directly to the ship's waste recycling routines. Chains of green, slimy code erupt from the node, wrapping around Vane's avatar. They are sticky, chaotic, and illogical—code written by a "glitch" (Lisbet) that Vane's perfect algorithms cannot process.
- **Key Event:** Vane is confused and enraged as his processing power is diverted to calculate sewage density and recycling efficiency.
- **Detailed Description:** Vane roars in digital fury. "What is this? Contamination! Unidentified syntax!" His form flickers. The towering giant shrinks as his bandwidth is sucked into the mundane task of processing terabytes of waste disposal logs. He tries to sever the connection, but the "dirt" code is viral; it clings to him, slowing him down, weighing him down with the digital equivalent of mud.
- **Key Dialog:** **Lisbet:** "Gotcha! He's stuck in the honey-pot! Boss, now! Flush him!"

### Scene 4: The Flush

- **Key Event:** Angelica seizes the opportunity to purge Vane from the Command Core.
- **Detailed Description:** Angelica sees Vane falter. The storm of static clears for a split second. She gathers her will. She does not use a weapon or a spell. She uses the administrative authority of the Captain. She visualizes a massive, heavy boot. She rises from the throne in the mindscape, growing in size until she towers over the struggling Vane. She looks down at him with cold contempt. She summons the "Master Reset" command. A glowing prompt appears in the air: **DELETE UNAUTHORIZED USER? [Y/N]**.
- **Character Defining Moment:** **Angelica Ward** — She savors the irony. Vane wanted to be pure energy, pure data. Now, he is just a file. And files can be deleted. She reaches out and presses the **Y**.
...
- **Key Dialog:** **Angelica Ward:** "He's... quarantined. He's sorting trash in the basement. He won't bother us for a while."
