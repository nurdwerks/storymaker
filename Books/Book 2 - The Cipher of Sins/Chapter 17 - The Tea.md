...
### Scene 2: The Alert / Flower Shop - Kitchen

- **Key Event:** Joyce receives a "Code Black" order from Lady Vesper to eliminate Angelica, which triggers her dormant sleeper agent conditioning.
  - _Character Defining Moment:_ **Joyce** — Her persona as a kindly grandmother is revealed to be a secondary layer over her original identity as a Palace-trained weapon.

---

### Scene 3: The Poison / Flower Shop - Kitchen to Parlor

- **Key Event:** Acting under absolute directives, Joyce poisons the team’s tea with "Bitter Almonds" (cyanide) and serves it with a mask of maternal care.
  - _Character Defining Moment:_ **Joyce** — She executes her lethal task with chilling efficiency, bypassing her own conscience to fulfill her programming.
  - _Key Dialog:_ **Joyce:** "Drink up, dears. It will settle your nerves and help the healing."
