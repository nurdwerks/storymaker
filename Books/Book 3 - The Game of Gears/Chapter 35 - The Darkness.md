...
- **Detailed Description:** The star chart zooms out, showing the ship's current location relative to Earth. Between them lies a massive, swirling cloud of dark matter and ionic storms—the Nebula. The computer plots a course straight through the center. It is a suicide run for any ship without a Navigator. But the alternative is drifting in the void until the reactor dies. Angelica studies the data. She sees the currents, the gravity wells, the safe pockets. To her, it isn't chaos; it's a puzzle.

### Scene 2: The Course

- **Key Event:** Angelica addresses the entire population of the ship via the general comms system, officially taking command.
- **Detailed Description:** Angelica activates the ship-wide broadcast. Her voice is amplified into every cabin, every corridor, every maintenance tunnel. She stands tall, gripping the edge of the console. She doesn't use the flowery language of the Highborn or the angry rhetoric of the Rebellion. She speaks plainly, like a mechanic explaining a repair.
  - _Character Defining Moment:_ **Angelica Ward** — She sheds the titles of "Princess" and "Rebel" and fully inhabits the role of "Captain." Her tone is calm, authoritative, and absolutely certain.
  - _Key Dialog:_ **Angelica Ward:** "This is Captain Ward. For three hundred years, we have been drifting in circles, afraid of the dark. We have fought each other for scraps while the stars waited outside. That ends today."
  - _Key Dialog:_ **Angelica Ward:** "I am setting a new course. It will be hard. It will be dangerous. We are going to fly through the storm. But on the other side... there is a blue world. There is rain. There is a home."
...
- **Key Event:** The leadership team—Angelica, Silas, Corinne, and Kaelen—assemble on the bridge.
- **Detailed Description:** They stand together at the viewport. Silas is cleaning his gun, grinning at the display of raw power. Corinne is composed, her hands clasped, watching the stars with a look of hungry ambition. Kaelen stands at Angelica's right hand, his hand resting on the hilt of his sword, a silent guardian. They are a motley crew—a smuggler, a socialite, a warrior, and a mechanic. But they are the new Council.
- **Key Event:** The ship enters the Nebula.
- **Detailed Description:** The stars are swallowed by the purple and black clouds of the nebula. Lightning arcs across the viewscreen. The ship shakes violently. Alarms blare, warning of radiation spikes and gravitational shear. Angelica does not flinch. She types in the course corrections, her fingers flying over the keys. She steers them into the throat of the storm.
  - _Character Defining Moment:_ **Angelica Ward** — She looks into the darkness and does not blink. She accepts the danger as the price of freedom.
  - _Key Dialog:_ **Angelica Ward:** "Let's go see what's out there. Engage."
