...
- **Key Event:** Lisbet warns that without a super-computer to calculate the jump vector, the drive is a suicide machine; Vane points to the Interface Throne.
  ...
  - _Character Defining Moment:_ **Lisbet** — Terrified by the lack of safety protocols, she realizes that Angelica is the only one who can navigate the "scream of the universe."
  - _Key Dialog:_ **Lisbet:** "The margin for error is zero. Less than zero. We'll jump into a star or the void."
