...
- **Key Event:** Angelica monitors the external security feed and sees the body of Lord Vermillion, which shows an anomalous, high-temperature thermal signature.
  - _Key Dialog:_ **Dr. Aris:** "He's not alive. He's incubating."

---

### Scene 2: The Twitch

- **Key Event:** Vermillion’s corpse undergoes a violent "reactivation," where his muscles snap his broken bones back into a functional, if mangled, state.
  - _Key Dialog:_ **Dr. Aris:** "The virus reactivates the nervous system. It jump-starts the engine. But there's no driver. It repairs structural damage by sacrificing long-term viability."
